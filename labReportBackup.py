...
def getdata1(i, tempimg):
	...
	if i == 12:
		partImage = tempimg[342:342 + horizontal_length,
					192 + i * vertical_length - 1:192 + (i + 1) * vertical_length - 1]
...
def main():
	...
	cv2.imwrite("test.jpg",scannedImage)
	...
	cv2.imwrite("test1.jpg", cutImage)
...
def main():
	...
	# if len(wdata[6])>5:
	# 	wdata[6]=wdata[6][1:]
	true_data = ['157', '5.39', '0.50', '2.10', '5.70', '41.8', '49.90', '0.04', '0.17', '0.46', '3.39', '4.05', '8.11',
				 '11.10', '13.9', '0.26', '233', '11.7', '337', '29.1', '86.5', '46.6']
	for i in [2, 3, 6, 7, 8, 18]:  # 这几个数据里中文较近，有时识别出其他数字，没有在前一步当作非法字符去除
		if len(wdata[i]) > len(true_data[i]):
			wdata[i] = wdata[i][1:]
	print wdata
